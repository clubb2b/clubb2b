  ...
  return <section id="services" className="py-20 bg-gradient-to-b from-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl mb-6 text-white tracking-wider font-semibold md:text-3xl">
            {t('services.title')}
          </h2>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            {coreServices.map((service, index) => <div key={index} className="group relative overflow-hidden bg-gradient-to-b from-gray-900/50 to-black/50 backdrop-blur-sm border border-gray-800 rounded-lg p-6 hover:border-white/20 transition-all duration-300">
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <Button onClick={service.action} variant="outline" className="border-white/20 text-white hover:bg-white hover:text-black transition-all duration-300">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {advancedServices.map((service, index) => <div key={index} className="bg-gradient-to-b from-gray-800/50 to-gray-900/80 backdrop-blur-sm p-8 rounded-xl border border-gray-700 text-center hover:border-white/30 transition-all duration-300 group">
                ...
                <Button onClick={service.action} className="bg-transparent border-2 border-white/40 text-white hover:bg-white hover:text-black px-8 py-3 font-light tracking-wider transition-all duration-300">
                  {t('services.explore')}
                </Button>
              </div>)}
          </div>
