...
const FinancingServices = () => {
  ...
  return <section className="py-16 bg-gradient-to-b from-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          {financingOptions.map((option, index) => <Card key={index} className="bg-gradient-to-b from-gray-800 to-gray-900 border border-gray-700 hover:border-white transition-all duration-300">
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  {option.features.map((feature, i) => <div key={i} className="flex items-center space-x-2">
        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg border border-gray-700 p-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-white mb-4 tracking-wide font-semibold text-base">
            ...
            <div className="space-y-4">
              <Button onClick={handleFinancingInquiry} className="w-full bg-white text-black hover:bg-gray-200 px-6 py-3 font-light tracking-wider transition-all duration-300">
                GET FINANCING QUOTE
              </Button>
              <Button onClick={handleInsuranceInquiry} className="w-full bg-transparent border border-white text-white hover:bg-white hover:text-black px-6 py-3 font-light tracking-wider transition-all duration-300">
                INSURANCE QUOTE
              </Button>
            </div>
          </div>
